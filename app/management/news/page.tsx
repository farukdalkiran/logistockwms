...
const newsData: NewsItem[] = [
  {
    ...
    excerpt:
      "Sportif direktörlerin yetersiz kaldığı kritik görüşmelerde masadaki tek pürüz: 101 oynamayı öğrenme şartı havada kalıyor.",
    content:
      "Furkan Karataş'ın depoya geri dönüş süreci adeta yılan hikayesine döndü. Sportif direktörlerin yetersiz kaldığı kritik transfer görüşmelerinde masadaki tek pürüzün '101 oynamayı öğrenmesi şartı' olduğu IK birimleri tarafından raporlandı.\n\nAncak depo mesailerinde 101 masasında ortalığı adeta kan gölüne çeviren ekibin yarattığı sinir krizleri ve toksik rekabet ortamı, Furkan Karataş'ı bu şarta sıcak bakmaktan alıkoyuyor. Masaya oturmanın psikolojik bir test haline geldiği belirtiliyor. Transfer görüşmeleri şimdilik havada kalmış durumda, gözler üst yönetimin vereceği esneklik kararlarında.",
    ...
    comments: [
      {
        id: 101,
        userId: 23232,
        userName: "Mehmet Dirican",
        userRole: "Depo Müdürü",
        text: "101 masası bir deponun vizyonunu ve kriz yönetimini belirler. Bu şart esnetilemez, ya öğrenecek ya öğrenecek.",
        time: "3 saat önce",
      },
      {
        id: 102,
        userId: 81035,
        userName: "Sadık Haste",
        userRole: "Depo Personeli",
        text: "Çift açmamayı öğrense gerisi benim için yine problem olmayacak.",
        time: "2 saat önce",
      },
      {
        id: 103,
        userId: 39760,
        userName: "Faruk Dalkıran",
        userRole: "Developer",
        text: "Ben masaya oturmuyorum, sistemi kim yazacak sonra? Furkan'a hak veriyorum.",
        time: "1 saat önce",
      },
    ],
  },
    ...
    comments: [
      {
        id: 201,
        userId: 77242,
        userName: "Buğra Erkul",
        userRole: "Online Takım Lideri",
        text: "Duygusallığa yer yok, operasyonel gereklilikler rotasyon şart koşar. Maltepe'nin de güçlü savunmalara ihtiyacı var.",
        time: "5 saat önce",
      },
      {
        id: 202,
        ...
        userName: "Özgür Kurt",
        userRole: "Depo Personeli",
        text: "Maltepe o kadar da kötü değil Enes, alışırsın kardeşim. Sadece paletler biraz ağır.",
        time: "4 saat önce",
      },
      {
        id: 203,
        userId: 10365,
        userName: "Enes Okumuş",
        userRole: "Depo Personeli",
        text: "Ben bitti demeden bitmez... O Maltepe'den geri döneceğim.",
        time: "1 saat önce",
      },
    ],
  },
  {
    ...
    excerpt:
      "Depoyu bıraktığı gibi bulan Halil Bey cinnet getirdi. Olay tuvalet kapısında gergin anlara sahne oldu.",
    content:
      "Halil Bey balayı izninden sahalara geri döndü, ancak depoyu tam da bıraktığı gibi bulması bardağı taşıran son damla oldu. Gördüğü operasyonel eksiklikler karşısında cinnet geçiren Halil Bey, faturayı doğrudan Sadık Bey'e kesti ve onu tuvaletteyken bastı.\n\nGörgü tanıklarının tutanaklarına göre Halil Bey'in, 'Ben yokken hiç mi bir şey yapmadınız?!' diyerek kapıya dayandığı ve Sadık Bey'in üzerine yürüdüğü öğrenildi. İnsan Kaynakları duruma el koyarak taraflardan savunma talep etti.",
    ...
    comments: [
      {
        ...
        userName: "Sadık Haste",
        userRole: "Depo Personeli",
        text: "Müsait bir zamanda detaylı ve uzun bir açıklama yapacağım. Olaylar çarpıtılıyor.",
        time: "1 gün önce",
      },
      {
        id: 302,
        userId: 42873,
        userName: "Halil Balta",
        userRole: "Depo Personeli",
        text: "Sadece 1 hafta yoktum... 1 HAFTA! Bütün raflar aynı duruyordu çıldırmamak elde değil.",
        time: "1 gün önce",
      },
      {
        id: 303,
        ...
        userName: "Ali Pıtır",
        userRole: "Depo Personeli",
        text: "Abi adam balayından gelmiş, elinde termal rulo ile tuvalet kapısı tekmeliyor. Zor ayırdık.",
        time: "12 saat önce",
      },
    ],
  },
  {
    ...
    excerpt:
      "Geciken primler sonrası ikilinin mesai saatleri içinde elde edilen faiz geliriyle VIP bilardo oynadığı iddia ediliyor.",
    content:
      "Depoda primlerin bu ay da gecikmesi personel arasında ciddi infial yarattı. İç denetim birimlerine ulaşan iddialara göre Oğuz Yılmaz, prim bütçesini yüksek faizde bekleterek kurum içi gayri resmi bir finansal döngü yarattı.\n\nElde edilen bu yüksek gelirle Ufuk Bey ile mesai saatleri içinde VIP bilardo oynadıkları yönündeki ihbarlar üzerine, İnsan Kaynakları ve Finans departmanı tarafından derinlemesine bir disiplin araştırması başlatıldı. Süreç sonuçlanana kadar yetkililer açıklama yapmaktan kaçınıyor.",
    ...
    comments: [
      {
        id: 401,
        userId: 10300,
        userName: "Oğuz Yılmaz",
        userRole: "Finans & Muhasebe Uzmanı",
        text: "Faiz falan yok, tamamen vizyon meselesi. Istakaları kendimiz aldık, yalan haber yapmayalım.",
        time: "2 gün önce",
      },
      {
        id: 402,
        ...
        userName: "Ufuk Çetin",
        userRole: "Depo Personeli",
        text: "Biz o sırada stres atarak vizyon geliştiriyoruz. Bilardo stratejidir.",
        time: "2 gün önce",
      },
      {
        id: 403,
        ...
        userName: "Semih Uçdu",
        userRole: "Depo Personeli",
        text: "Primler yatana kadar o bilardo masasından kalkmayın beyler.",
        time: "1 gün önce",
      },
    ],
  },
  {
    ...
    excerpt:
      "Transfer ürünlerini 2 gün boyunca büyüteçle bekletip raflara aktararak kendi gecikme rekorunu kırdı.",
    content:
      "Buğra Amir'deki koltuk sevdası ve detaycılık herkesi şaşkına çevirmeye devam ediyor. Bu hafta gelen kritik transfer ürünlerini tam 2 gün boyunca büyüteçle mikroskobik incelemeye tabi tutup ardından raflara aktaran ünlü depo amiri, siparişleri bir kez daha geciktirmeyi başararak kendi operasyonel rekorunu kırdı.\n\nLojistik birimi, bu inceleme süreçleri nedeniyle teslimat sürelerini (SLA) revize etmek zorunda kaldı. Merkez depo yönetimi konuyla ilgili performans iyileştirme raporu talep etti.",
    ...
    comments: [
      {
        ...
        userName: "Buğra Erkul",
        userRole: "Online Takım Lideri",
        text: "Kontrol edilmeyen mal, iade maldır. Süreçleri ben belirliyorum, kalite tesadüf değildir.",
        time: "3 gün önce",
      },
      {
        id: 502,
        ...
        userName: "Ali Pıtır",
        userRole: "Depo Personeli",
        text: "Sisteme girişini yapsaydın bari beklerken abi, stok sıfır görünüyor 2 gündür.",
        time: "2 gün önce",
      },
      {
        id: 503,
        ...
        userName: "Faruk Dalkıran",
        userRole: "Developer",
        text: "Veritabanında transfer tarihi ile kabul tarihi arasında 48 saat fark var, sistemi bozuyorsunuz abi.",
        time: "1 gün önce",
      },
    ],
  },
  {
    ...
    excerpt:
      "Görüş kapasitesini %5'ten %14'e çıkarmak için devasa bütçe ayıran Emre Bey ameliyat masasına yatıyor.",
    content:
      "Deponun turuncu saçlı, kara kaşlı sevilen ismi Emre Bey nihayet ameliyat masasına yatıyor! Mevcut %5 olan görüş kapasitesini %14 seviyesine çıkarmak için kesenin ağzını açan Emre Bey, bu spesifik göz operasyonu için tam 1.5 Milyon TL bütçe ayırdı.\n\nBaşarılı geçmesi beklenen operasyon sonrası, kendisinin el terminalleriyle barkod okuma hızında ve genel toplama (picking) performansında ciddi bir artış bekleniyor. Ekip arkadaşları ve yönetim kendisine acil şifalar diliyor.",
    ...
    comments: [
      {
        id: 601,
        userId: 10294,
        userName: "Emre Yorulmaz",
        userRole: "Depo Personeli",
        text: "Ameliyattan sonra o barkodları terminalsiz direkt gözümle okuyacağım. Bekleyin beni.",
        time: "4 gün önce",
      },
      {
        id: 602,
        ...
        userName: "Emre Alan",
        userRole: "Depo Personeli",
        text: "Geçmiş olsun adaş. Çabuk dön, raflar seni bekler.",
        time: "3 gün önce",
      },
      {
        id: 603,
        ...
        userName: "Mehmet Dirican",
        userRole: "Depo Müdürü",
        text: "Barkod okuma hızında %200 artış bekliyorum Emre, geçmiş olsun.",
        time: "2 gün önce",
      },
    ],
  },
  {
    ...
    excerpt:
      "3 gün zannedilen yıllık iznin IK kayıtlarında 8 gün olduğu ortaya çıktı, saha ile iletişim tamamen koptu.",
    content:
      "Semih Bey yıllık izinde adeta sırra kadem bastı! Ekip tarafından operasyonel planlamada 3 gün zannedilen yıllık izni, doldurduğu IK formunda 8 gün olarak ortaya çıkınca vardiya planlaması alt üst oldu.\n\nAntalya'nın sarp dağlarında kamp yaptığı bilinen ve GSM iletişimi tamamen kopan Semih Bey'den şu ana kadar hiçbir haber alınamıyor. Depo yönetimi sağ salim dönüp dönmeyeceğini merakla beklerken, yedek vardiya personeli devreye alındı.",
    ...
    comments: [
      {
        ...
        userName: "Özgür Kurt",
        userRole: "Depo Personeli",
        text: "Antalya sıcaktır şimdi, iyi tatiller kardeşim dönme boşver.",
        time: "3 gün önce",
      },
      {
        id: 703,
        ...
        userRole: "Depo Personeli",
        text: "...",
        time: "(Sistem Notu: Personel kapsama alanı dışında)",
      },
    ],
  },
  {
    ...
    icon: Activity,
    image:
      "https://www.talentcards.com/blog/wp-content/uploads/people_development.jpg",
    excerpt:
      "Sistemi istikrarla kullanan ve açık bulmada usta olan Ali Pıtır'a yönetimden büyük jest hazırlığı.",
    content:
      "Ali Pıtır'dan LogiStock sistemlerine muazzam destek geldi. Bütün fonksiyonları yüksek istikrarla kullanan, sistemdeki log açıklarını bulup test eden Ali Bey, geliştirici ekibimize sürekli kritik dönütler vererek WMS evrimine doğrudan katkı sağlıyor.\n\nYönetim kurulunda, bu özverili çalışmaları ve QA (Kalite Güvence) süreçlerine gönüllü desteği karşılığında kendisine WMS operasyonlarından %15 hisse verilmesi ciddi şekilde tartışılıyor. Yazılım ekibi kendisine teşekkürlerini iletti.",
    ...
    comments: [
      {
        ...
        userName: "Faruk Dalkıran",
        userRole: "Developer",
        text: "Adam QA test mühendisi gibi çalışıyor helal olsun, logları okumaktan gözlerim kanadı ama Ali abi buluyor açığı.",
        time: "5 gün önce",
      },
      {
        id: 802,
        ...
        userName: "Ali Pıtır",
        userRole: "Depo Personeli",
        text: "Teşekkürler Faruk hocam. Hisse devir sözleşmesi nerede imzalanıyor? Kalemi hazırladım.",
        time: "5 gün önce",
      },
      {
        id: 803,
        ...
        userName: "Oğuz Yılmaz",
        userRole: "Finans & Muhasebe Uzmanı",
        text: "Şirket değerlemesi yapmadan hisse falan dağıtmıyoruz, önce primleri halledelim.",
        time: "4 gün önce",
      },
    ],
  },
  ...
  const filteredNews = useMemo(() => {
    return newsData.filter((news) => {
      const matchesCategory =
        activeCategory === "TÜMÜ" || news.category === activeCategory;
      const matchesSearch =
      ...
      <div className="w-full bg-white border-b border-slate-200 h-10 flex items-center shadow-sm relative z-10 overflow-hidden">
        ...
        <div className="flex-1 whitespace-nowrap overflow-hidden relative text-slate-700">
          <div className="animate-[marquee_25s_linear_infinite] inline-block text-xs font-semibold tracking-wide">
            <span className="mx-8 text-[#dc3545]">
              • FURKAN KARATAŞ TRANSFERİNDE 101 KRİZİ SÜRÜYOR
            </span>
            <span className="mx-8">
              • 18.08.2026 TARİHİ TÜM DÜNYADA RESMİ TATİL İLAN EDİLDİ
            </span>
            <span className="mx-8 text-[#dc3545]">
              • YENİ SİSTEM GÜNCELLEMESİ YAYINLANDI, İZİN TALEPLERİNİ SİSTEMDEN
              GİRİNİZ
            </span>
            <span className="mx-8">
              • SEMİH BEY'İ GÖRENLERİN İK BİRİMİNE BİLDİRMESİ RİCA OLUNUR
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-slate-500 font-medium text-sm mt-1">
              Departman duyuruları, personel hareketleri ve operasyonel
              güncellemeler.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {filteredNews.length === 0 && (
              <div className="bg-white border border-slate-200 rounded-md p-10 text-center flex flex-col items-center justify-center shadow-sm">
                ...
                <p className="text-slate-500 text-sm mt-1">
                  Seçilen filtrelere veya arama terimine uygun bir haber yok.
                </p>
              </div>
            )}
                ...
                >
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      ...
                      {/* Sadece Özet Görünür */}
                      <p
                        className={`text-slate-600 text-sm font-medium flex-1 ${!isExpanded ? "line-clamp-2" : ""}`}
                      >
                        {news.excerpt}
                      </p>
                      ...
                      <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between">
                        <div className="flex items-center gap-4 text-xs font-semibold text-slate-400">
                          <span className="flex items-center gap-1">
                            <ThumbsUp size={14} /> {news.likes}
                          </span>
                          <span className="flex items-center gap-1">
                            <MessageSquare size={14} /> {news.comments.length}
                          </span>
                        </div>
                        <button
                    ...
                    <div className="flex flex-col border-t border-slate-200 bg-slate-50">
                        ...
                        {news.tags.length > 0 && (
                          <div className="flex items-center gap-2 mt-6 pt-6 border-t border-slate-200">
                            ...
                            {news.tags.map((tag) => (
                              <span
                                key={tag}
                                className="text-[10px] font-bold text-slate-500 bg-white px-2.5 py-1 rounded border border-slate-200"
                              >
                                {tag}
                              </span>
                            ))}
                      ...
                      <div className="p-6 md:p-8 bg-white">
                        <h3 className="text-sm font-bold text-slate-800 mb-5 flex items-center gap-2">
                          <MessageSquare size={16} className="text-[#dc3545]" />{" "}
                          Yorumlar ve Savunmalar ({news.comments.length})
                        </h3>
                        ...
                        <div className="flex flex-col gap-4">
                          {news.comments.length > 0 ? (
                            ...
                            <p className="text-xs text-slate-500 font-medium italic">
                              Bu içeriğe henüz savunma veya yorum eklenmemiş.
                            </p>
                          )}
                        </div>
                        ...
                        <div className="mt-6 pt-6 border-t border-slate-100 flex gap-3 items-start">
                          ...
                          <div className="flex-1 flex flex-col gap-3">
                            <textarea
                              ...
                              onChange={(e) =>
                                handleCommentChange(news.id, e.target.value)
                              }
          ...
          <div className="lg:col-span-4 flex flex-col gap-6 w-full sticky top-6">
                ...
                <li className="flex gap-3">
                  ...
                  <div className="flex flex-col justify-center">
                    <span className="text-sm font-bold text-slate-800">
                      Dinamik Sayım Başlangıcı
                    </span>
                    <span className="text-[11px] text-slate-500 font-medium mt-0.5">
                      Karantina rafları hariç tüm koridorlar.
                    </span>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <span className="text-[11px] text-slate-500 font-medium mt-0.5">
                      Finans birimi onayları sisteme düşecek.
                    </span>
                  </div>
                </li>
              </ul>
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-5">
              ...
              <div className="flex flex-col gap-4 text-xs font-medium text-slate-600">
                <div className="flex gap-2 items-start">
                  ...
                  <p>
                    Vardiya başlangıcından 15 dakika sonrasına kadar check-in
                    yapmayan personel sisteme "Geç" olarak işlenecektir.
                  </p>
                </div>
                <div className="flex gap-2 items-start">
                  <span className="text-[#dc3545] font-bold">•</span>
                  <p>
                    Zebra termal yazıcılarda rulo değişimi sonrası kalibrasyon
                    düğmesine basmayı unutmayınız.
                  </p>
                </div>
                <div className="flex gap-2 items-start">
                  <span className="text-[#dc3545] font-bold">•</span>
                  <p>
                    Karantina raflarında bekleyen iade ürünler için Yönetici/İK
                    onayı kesinlikle zorunludur.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg shadow-sm p-5 flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-red-800 mb-1">
                  İSG ve Disiplin Kuralı
                </h4>
                <p className="text-[11px] font-medium text-red-700 leading-relaxed">
                  Forklift yollarında yürümek, transpalet üzerine çıkmak ve depo
                  içerisinde yetkisiz elektrikli araç kullanmak tutanak
                  sebebidir. Lütfen tüm depolama kurallarına uyun.
                </p>
              </div>
            </div>
          </div>
